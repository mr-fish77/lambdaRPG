...
public class Balthazar extends Mage{
    ...
    public Balthazar(){
        ...
        super("Balthazar",628,100,189,199,292,369,20,289,0,0,0,0); //nom, vie, mana, defense, force, vitesse, magie, recupération, resistance magique, poison, brulure, sommeil, paralysie
    }
    ...
    */
    public boolean attaque5(Personnage J2){ //degats
        ...
        if( this.mana >= 80){
            ...
            if(degat >= 0){
                J2.vie -= degat;
                System.out.println(this.nom + " fait une attaque physique puissante. Il cause " +degat+ " degats a " + J2.nom );
            }else{
    ...
    public boolean attaque6(Personnage J2){ //degats + brulure
    ...
    public boolean attaque7(Personnage J2){ //degats + diminution resistance magique
        ...
        if( this.mana >= 60){
            ...
            if(degat >= 0){
                J2.vie -= degat;
                System.out.println(this.nom + " fait une attaque magique. Il cause " +degat+ " degats a " + J2.nom+ " et diminue sa resistance aux attaques magiques de 20%" );
    ...
    public boolean attaque8(){ 
        ...
        if( this.mana >= 50){
            this.vie +=150;
            System.out.println(this.nom+" recupere 150 HP");
            this.mana  -= 50;
            att = true;
        }else{
            System.out.println(this.nom + " n'a pas assez de mana pour attaquer" );
