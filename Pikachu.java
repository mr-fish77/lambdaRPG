...
public class Pikachu extends Mage{
    ...
    public Pikachu(){
        ...
        super("Pikachu", 680,100,229,229,272,405,20,329,0,0,0,0); //nom, vie, mana, defense, force, vitesse, magie, recupération, resistance magique, poison, brulure, sommeil, paralysie
    }
    ...
    public boolean attaque5(Personnage J2){ //Attaque puissante, mais J1 subit 1/6 des degats
    ...
    public boolean attaque6(Personnage J2){ //attaque degats aleatoires 
    ...
    public boolean attaque7(){ // Augmente recup de mana de 50%
    ...
    public boolean attaque8(Personnage J2){ //attaque faible mais provoque paralysie
