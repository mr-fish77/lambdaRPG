...
public class LambdaRpg{
	...
	*/
	public static void jouerSuite (double arret){
	 ...
	 public static void dialogueMage(){   // Methode de dialogue pour alleger choix des personnages
		...
		System.out.println(" 229 vitesse                159 vitesse                339 vitesse                259 vitesse");
	}
	 ...
	 public static void dialogueGuerrier(){ // Methode de dialogue pour alleger choix des personnages
		...
		System.out.println(" 179 vitesse                199 vitesse                189 vitesse                199 vitesse");
	}
	 ...
	 public static void dialogueAssassin(){  // Methode de dialogue pour alleger choix des personnages
		...
		System.out.println(" 262 vitesse                251 vitesse                262 vitesse                284 vitesse");
	 ...
	 public static void dialogueNecromancien(){
		...
		System.out.println(" 235 vitesse                219  vitesse                219  vitesse                215 vitesse");
	}
    ...
    public static void intro () {
        ...
        texteLent("Veuillez passer votre invite de commande en plein ecran pour une meilleur experience de jeu", 100);
        System.out.println("");
        texteLent("Appuyez sur espace puis entree pour commencer",150);
   ...
   */
	...
	//Ajoute un l'abs de temps en l'intro et le jeux
        ...
        texteLent("Joueur 1 choisis ta classe:",150);
        jouerSuite(1000);
        dialogueintro();
        ...
        texteLent("Joueur 2 choisis ta classe :",150);
        jouerSuite(1000);
        dialogueintro();
